...
var serverRoutes_1 = __importDefault(require("./Routes/serverRoutes"));
var Server = /** @class */ (function () {
    ...
    Server.prototype.config = function () {
        ...
        this.app.use(express_1.default.urlencoded(({ extended: false }))); //por si para usar formato html   
    };
    Server.prototype.routes = function () {
        this.app.use('/', serverRoutes_1.default);
    };
